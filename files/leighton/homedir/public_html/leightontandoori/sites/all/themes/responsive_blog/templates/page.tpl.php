  ...
  <header id="header" class="clearfix">
    ...
    <?php if (theme_get_setting('socialicon_display', 'responsive_blog')): ?>
      ...
      <div class="social-profile">
       <div style="font-weight:bold; color: purple; padding:0px;">
	020 7267 6726 <br>
	020 7482 6593
	</div>
	<!-- <ul>
...
?>
<div class="slides displaynone">
              <a href="<?php print url($slide3_url); ?>"><img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'responsive_blog') . '/images/slide-image-' . $i . '.jpg'; ?>" class="pngfix"/></a>
              <?php if($slide1_desc) { print '<div class="featured-text">' . $slide3_desc . '</div>'; } ?><!-- .featured-text -->
            </div>
<?php
}
?>
  ...
  <footer id="footer-bottom">
    ...
    <div id="bottom" class="clearfix">
      ...
      <div class="credit"><?php print t('Powered by'); ?>  <a href="http://www.podamibe.co.uk" target="_blank">Podamibe</a></div>
    </div>
  </footer>
